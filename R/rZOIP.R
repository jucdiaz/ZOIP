...
#' rZOIP(n, mu = 0.5, sigma = 0.1,p0 = 0.08333333, p1 = 0.08333333,family='R-S')#' @param n numero de observaciones. si length(n) > 1, el tamañano se tomara como el numero requerido.
