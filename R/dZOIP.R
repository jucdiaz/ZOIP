...
#'
#'where \eqn{p0 \geq 0} represents the probability that \eqn{x = 0, p1 \geq 0} represents the probability
#'that \eqn{x = 1, 0 \leq p0 + p1 \leq 1} and \eqn{f (x; \mu, \sigma)} represents some of the functions of
